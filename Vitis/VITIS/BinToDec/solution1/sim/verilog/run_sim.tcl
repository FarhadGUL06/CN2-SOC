...
if {[file isfile BinToBcd.autotvin.dat]} {
	file delete -force BinToBcd.autotvin.dat
}

if {[file isfile BinToBcd.autotvout.dat]} {
	file delete -force BinToBcd.autotvout.dat
}
