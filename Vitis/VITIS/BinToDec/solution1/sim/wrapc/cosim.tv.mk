...
$(ObjDir)/BinToBcd-tb.cpp_pre.cpp.tb.o : BinToBcd-tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling BinToBcd-tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/BinToBcd.cpp_pre.cpp.tb.o : BinToBcd.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling BinToBcd.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
