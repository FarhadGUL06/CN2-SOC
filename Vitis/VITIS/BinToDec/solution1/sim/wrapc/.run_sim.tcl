...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "BinToBcd.autotvin.dat"
	set constFileTvOut       "BinToBcd.autotvout.dat"
	set constFileHdlTvIn     "BinToBcd.autohdltvin.dat"
	set constFileHdlTvOut    "BinToBcd.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
