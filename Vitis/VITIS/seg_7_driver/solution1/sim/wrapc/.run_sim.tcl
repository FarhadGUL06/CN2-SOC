...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Aplicatii/Vitis/Vitis_HLS/2022.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);D:/Aplicatii/Vitis/Vitis_HLS/2022.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Aplicatii/Vitis/Vitis_HLS/2022.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Aplicatii/Vitis/Vitis_HLS/2022.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "seg_7_driver.autotvin.dat"
	set constFileTvOut       "seg_7_driver.autotvout.dat"
	set constFileHdlTvIn     "seg_7_driver.autohdltvin.dat"
	set constFileHdlTvOut    "seg_7_driver.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
