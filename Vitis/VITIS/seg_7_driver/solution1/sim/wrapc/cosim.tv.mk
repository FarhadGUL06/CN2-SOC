...
$(ObjDir)/seg_7_driver-tb.cpp_pre.cpp.tb.o : seg_7_driver-tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling seg_7_driver-tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/seg_7_driver.cpp_pre.cpp.tb.o : seg_7_driver.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling seg_7_driver.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
