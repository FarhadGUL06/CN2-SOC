...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.seg_7_driver.autotvin_refresh_signal.dat"
         "c.seg_7_driver.autotvin_digit1.dat"
         "c.seg_7_driver.autotvin_digit2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.seg_7_driver.autotvout_seg_7_data.dat"
         "rtl.seg_7_driver.autotvout_seg_7_enable.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
