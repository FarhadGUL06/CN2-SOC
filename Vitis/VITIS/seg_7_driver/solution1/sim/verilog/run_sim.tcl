...
if {[file isfile seg_7_driver.autotvin.dat]} {
	file delete -force seg_7_driver.autotvin.dat
}

if {[file isfile seg_7_driver.autotvout.dat]} {
	file delete -force seg_7_driver.autotvout.dat
}
